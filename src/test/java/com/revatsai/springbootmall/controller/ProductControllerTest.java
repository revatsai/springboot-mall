...
public class ProductControllerTest {
    ...
    public void deleteProduct_deleteNonExistingProduct() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders
                .delete("/products/{productId}", 20000); // 改成不存在的productId
    ...
    public void getProducts() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.results", hasSize(5))); // 返回的results是個list，只是想測試這個list裡的個數有幾個，可以使用hasSize這個方法，hasSize(5)預期有5筆
    }
    ...
    public void getProducts_sorting() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.results[0].productId", equalTo(6))) // 一筆一筆的取得results裡的商品數據檢查，並對裡面的數據進行檢查
                .andExpect(jsonPath("$.results[1].productId", equalTo(5))) // 檢查productId是否為5
